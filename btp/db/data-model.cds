...
type JobType   : String enum {
    MASSUPDATE_CLASSIFICATIONS = 'MASSUPDATE_CLASSIFICATIONS';
    IMPORT_SCORING = 'IMPORT_SCORING';
    IMPORT_LANGUAGE_VERSION = 'IMPORT_LANGUAGE_VERSION';
    IMPORT_RELEASE_STATE = 'IMPORT_RELEASE_STATE';
    IMPORT_MISSING_CLASSIFICATION = 'IMPORT_MISSING_CLASSIFICATION';
    IMPORT_CLOUD_CLASSIFICATIONS = 'IMPORT_CLOUD_CLASSIFICATIONS';
    CLEANUP_CLASSIFICATIONS = 'CLEANUP_CLASSIFICATIONS';
    CLEANUP_CLEAN_CORE_LEVEL = 'CLEANUP_CLEAN_CORE_LEVEL';
}
